						...
						<table id="data_grid" class="table table-bordered table-hover">
							...
							<tbody>
								...
								foreach ($records as $r) {
									...
									$button .= '<li><a href="' . base_url('admin/biaya-kirim/edit/') . $id . '"><i class="fa fa-edit"></i> Edit</a></li>';
									$button .= '<li><a href="' . base_url('admin/biaya-kirim/delete/') . $id . '"><i class="fa fa-trash"></i> Remove</a></li>';
									$button .= '</ul>';
									$button .= '</div>';
									echo '<tr>';
