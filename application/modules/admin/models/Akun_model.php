...
class Akun_model extends CI_Model
{
	...
	protected $primKey = "id_akun";
	protected $indexKey = 'nama_akun';
	...
	function get_data($arrWhere = array(), $arrOrder = array(), $limit = 0)
	{
		...
		$this->db->select('id_akun, nama_akun, nama_lengkap_akun, email_akun, status_akun');
		$this->db->from($this->tbl_akun);
	...
	{
		$this->db->trans_start();
		$this->db->insert($this->tbl_akun, $dataInfo);
	...
	{
		$this->db->where($this->indexKey, $id);
		$this->db->update($this->tbl_akun, $dataInfo);
