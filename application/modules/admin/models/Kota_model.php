...
class Kota_model extends CI_Model
{
	...
	protected $primKey = 'id_kota';
	protected $indexKey = 'id_kota';
	protected $order = array('nama_kota' => 'asc'); // default order
	...
	{
		$this->db->trans_start();
		$this->db->insert($this->tbl_kota, $dataInfo);
	...
	function update_data($dataInfo, $id)
	{
		...
		$this->db->update($this->tbl_kota, $dataInfo);
