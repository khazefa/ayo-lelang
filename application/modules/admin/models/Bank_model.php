...
{
	protected $tbl_akun_bank = 'pelelang_akun_bank';
	protected $primKey = 'id_akun_bank';
	protected $indexKey = 'id_pelelang';
	protected $order = array('bank_akun_bank' => 'asc'); // default order
	...
	function count_all()
	{
		$this->db->from($this->tbl_akun_bank);
	...
	{
		$this->db->trans_start();
		$this->db->insert($this->tbl_akun_bank, $dataInfo);
	...
	function update_data($dataInfo, $id)
	{
		...
		$this->db->update($this->tbl_akun_bank, $dataInfo);
	...
	{
		$this->db->where($this->indexKey, $id);
		$this->db->delete($this->tbl_akun_bank);
